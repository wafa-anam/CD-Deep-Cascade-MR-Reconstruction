...
model_path =  "../Models/model_wwnet_ikik_mc_r5.h5"
...
train_generator = DataGenerator(train, dim = (H, W), under_masks = var_sampling_mask,  crop = crop,                            batch_size = batch_size, n_channels = channels, nslices = nslices, shuffle=True)

val_generator = DataGenerator(val, dim = (H, W), under_masks = var_sampling_mask,  crop = crop,                            batch_size = batch_size, n_channels = channels, nslices= nslices, shuffle=False)
